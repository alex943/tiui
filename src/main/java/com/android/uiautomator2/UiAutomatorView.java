...
package com.android.uiautomator2;

import com.android.uiautomator2.actions.ExpandAllAction;
import com.android.uiautomator2.actions.ImageHelper;
import com.android.uiautomator2.actions.ToggleNafAction;
import com.android.uiautomator2.instrumentation.page.PagePanelView;
import com.android.uiautomator2.instrumentation.model.TiPair;
import com.android.uiautomator2.instrumentation.TiRuntime;
import com.android.uiautomator2.instrumentation.TiRuntimeObserver;
...
import com.android.uiautomator2.tree.AttributePair;
...
public class UiAutomatorView extends Composite {
    ...
    @Deprecated private TableViewer mAppInfoTableViewer;
    public PagePanelView mPageViewPanel;
    ...
    private void rightMethodSlash(SashForm baseSash) {
        SashForm rightSash = new SashForm(baseSash, SWT.VERTICAL);
        Group grpNodeDetail = new Group(rightSash, SWT.NONE);
        grpNodeDetail.setLayout(new FillLayout(SWT.HORIZONTAL));
        grpNodeDetail.setText("Method Tree");
        Composite rightBase = new Composite(grpNodeDetail, SWT.BORDER);

        rightBase.setLayout(new FillLayout());
        mPageViewPanel = new PagePanelView(rightBase, SWT.NONE);
    }

    private void rightSlash(SashForm baseSash) {
        SashForm rightSash = new SashForm(baseSash, SWT.VERTICAL);

        // TODO upper-right base contains the toolbar and the tree
        ...
        // TODO lower-right base contains the detail group
    ...
    public UiAutomatorView(Composite parent, int style) {
        ...
        baseSash.setWeights(new int[] {3, 3, 3});
    ...
    public void reload(UiAutomatorModel model) {
        // load xml into tree
        ...
        wrapper.addChild(model.getXmlRootNode());
