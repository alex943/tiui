...
import com.android.uiautomator2.actions.*;
...
public class UiAutomatorViewer extends ApplicationWindow {
    public UiAutomatorView mUiAutomatorView;
    ...
    protected Control createContents(Composite parent) {
        Composite window = new Composite(parent, SWT.BORDER);
        ...
        toolBarManager.add(new StartAgentAction(this));
        toolBarManager.add(new StopAgentAction(this));
        ...
        ToolBar tb = toolBarManager.createControl(window);
        tb.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));

        mUiAutomatorView = new UiAutomatorView(window, SWT.BORDER);
