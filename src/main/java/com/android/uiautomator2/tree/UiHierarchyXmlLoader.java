...
package com.android.uiautomator2.tree;
...
public class UiHierarchyXmlLoader {
    ...
    private com.android.uiautomator2.tree.BasicTreeNode mRootNode;
    private List<Rectangle> mNafNodes;
    private List<com.android.uiautomator2.tree.BasicTreeNode> mNodeList;
     ...
     * @return
     */
    public com.android.uiautomator2.tree.BasicTreeNode parseXml(String xmlPath) {
        mRootNode = null;
        mNafNodes = new ArrayList<Rectangle>();
        mNodeList = new ArrayList<com.android.uiautomator2.tree.BasicTreeNode>();
        ...
        DefaultHandler handler = new DefaultHandler(){
            com.android.uiautomator2.tree.BasicTreeNode mParentNode;
            com.android.uiautomator2.tree.BasicTreeNode mWorkingNode;
            @Override
            public void startElement(String uri, String localName, String qName,
                ...
                if ("hierarchy".equals(qName)) {
                    ...
                    com.android.uiautomator2.tree.UiNode tmpNode = new UiNode();
                    for (int i = 0; i < attributes.getLength(); i++) {
