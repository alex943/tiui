...
public class UiNode extends BasicTreeNode {
    ...
    public static final String CLASS_KEY = "classL";
    public static final String RES_ID = "resHex";

    public void addAtrribute(String key, String value) {
        if (value != null && !value.isEmpty()) {
            if (key.equals("resource-id")) {
                String _value = ViewNodeProperties.getInstance().getId(value);
                mAttributes.put(RES_ID, _value);
                updateDisplayName();
                return;
            } else if (key.equals("class")) {
                String _value = value.replaceAll(".", "/");
                _value = "L" + _value + ";";
                mAttributes.put(CLASS_KEY, _value);
                updateDisplayName();
                return;
            }
        }
